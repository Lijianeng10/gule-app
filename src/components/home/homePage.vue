<template>
    <div class="homePage">
        ...
        <mt-swipe :auto="0">
            <mt-swipe-item v-for="(item,index) in banners" :key="index" v-show='index===mark'>
                <img :src="item.pic" alt="" width="100%" height="180px">
                <!--@click="banner(item.bid)"-->
            </mt-swipe-item>
            <div class="bullet">
                <span v-for='(item,index) in banners' :class="{'active':index===mark}" @click='change(index)'></span>
            </div>
        </mt-swipe>
